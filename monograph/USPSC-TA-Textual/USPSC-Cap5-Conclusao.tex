...
A implementação de um \textit{frontend} para a extensão para o Instagram também provou que é possível integrar esse modelo de maneira fluida com uma página dinâmica, que sofre mutações o tempo todo.
...
\begin{itemize}
    ...
    \item Na prática, se o conteúdo for classificado como inadequado a ser mostrado para uma determinada pessoa, essa postagem não deveria nem aparecer, o que elimina o sentido de ter um \textit{frontend} como feito nesse projeto.

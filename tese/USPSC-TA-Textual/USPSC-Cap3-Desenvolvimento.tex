...
O script lê 3 vezes todas as imagens de uma pasta específica, faz o mesmo redimensionamento e otimização de imagem que o content script faz,
...
O código lê todas as imagens três vezes para analisarmos a consistência dos resultados.

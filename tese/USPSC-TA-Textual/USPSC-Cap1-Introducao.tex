...
Ao final, os objetivos se resumem em:
\begin{enumerate}
...
Porém, o código-fonte JavaScript, o código Python utilizado para testes e os demais arquivos utilizados nessa tese estão disponíveis em um repositório público no GitHub \footnote{Repositório GitHub do projeto: \url{https://github.com/pecazeco/InstaChildGuard}.}.

\section{Organização do texto} \label{sec:organizacao_do_texto}
Escrever aqui como ficou a organização dos capítulos